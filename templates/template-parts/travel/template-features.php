<div id="features" class="page-section page-section--blue" data-matching-link="#features-link">
      <div class="wrapper">
        <h2 class="section-title"><img loading="lazy" class="section-title__icon" src="imgaes/icons/star.svg" /> Our <strong>Features</strong></h2>
        <div class="row row--gutters-large generic-content-container">
          <div class="row__medium-6">
            <div class="feature-item">
              <img loading="lazy" class="feature-item__icon" src="imgaes/icons/rain.svg" />
            ...
            <div class="feature-item">
              <img loading="lazy" class="feature-item__icon" src="imgaes/icons/globe.svg" />
          ...
          <div class="row__medium-6">
            <div class="feature-item">
              <img loading="lazy" class="feature-item__icon" src="imgaes/icons/wifi.svg" />
            ...
            <div class="feature-item">
              <img loading="lazy" class="feature-item__icon" src="imgaes/icons/fire.svg" />
